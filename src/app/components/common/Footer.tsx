...
export default function Footer() {
    return (
        <>
            <section className='footer flex flex-col gap-8 lg:flex-row items-center bg-black-100 text-white px-6 pt-6 lg:px-20 lg:pt-20 justify-between'>
                <div className='gap-2'>
                ...
                <div className='uppercase text-6xl font-bold'>SUGANTH  ALAGESAN</div>
            </section>
